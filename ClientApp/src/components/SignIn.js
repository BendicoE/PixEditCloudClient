                ...
                React.createElement("form", { onSubmit: handleSubmit(this.onFormSubmit), autoComplete: 'on' },
                    React.createElement("div", { className: 'row' },
                        React.createElement("div", { className: 'input-group mb-3 col-sm-4' },
                            React.createElement(redux_form_1.Field, { name: 'username', component: 'input', type: 'text', className: 'form-control', placeholder: 'Username' })),
                        React.createElement("div", { className: 'input-group mb-3 col-sm-4' },
                            React.createElement(redux_form_1.Field, { name: 'password', component: 'input', type: 'password', className: 'form-control', placeholder: 'Password' })),
                        React.createElement("div", { className: 'input-group mb-3 col-sm-4' },
                            React.createElement(redux_form_1.Field, { name: 'serialNo', component: 'input', type: 'text', className: 'form-control', placeholder: 'Serial Number' }))),
                    React.createElement("div", { className: 'row' },
                        React.createElement("div", { className: 'input-group mb-3 col-sm-4' },
